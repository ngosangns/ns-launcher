...
final class LauncherViewModel: ObservableObject {
    ...
    /// True while an install, import, rescan, or launch task is active.
    ...
    /// Imports an existing game folder by updating paths and writing launcher metadata.
    ...
    /// Revalidates the selected install directory.
    ...
    /// Creates an existing-install copy without changing the persisted strategy.
